<?php $linkActive = "list-group-item-success active";?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-md navbar-dark bg-secondary">
    <div class="container">
        <button class="btn btn-outline-light" data-toggle="collapse" data-target="#menu" type="button">
            <svg class="bi bi-list" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
            </svg>
        </button>
        <a href="/" class="navbar-brand m-auto">SMA Negeri 1 Aek Kuasan</a>
    </div>
</nav>
    ...
    <div class="row py-3">
        <div class="col-md-12 col-lg-3 collapse" id="menu">
            <div class="detail text-center">
                ...
                <?php endif ?>
                <br>
                <b><?= $this->session->user->nama ?></b>
                <p><?= $this->session->user->jenis_kelamin ?></p>
            </div>
            <hr>
            ...
            <ul class="list-group">
                <a href="/" class="list-group-item list-group-item-action <?= !uri_string() ? $linkActive : ''?>">
                ...
                <a href="/kelas" class="list-group-item list-group-item-action <?= uri_string() == 'kelas' ? $linkActive : ''?>">
                ...
                <a href="/guru" class="list-group-item list-group-item-action <?= uri_string() == 'guru' ? $linkActive : ''?>">
                ...
                <a href="/siswa" class="list-group-item list-group-item-action <?= uri_string() == 'siswa' ? $linkActive : ''?>">
                    <svg class="bi bi-people-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                    </svg>
                    Data Siswa
                </a>
                <a href="/kriteria" class="list-group-item list-group-item-action <?= uri_string() == 'kriteria' ? $linkActive : ''?>">
                ...
                <a href="/penilaian" class="list-group-item list-group-item-action <?= uri_string() == 'penilaian' ? $linkActive : ''?>">
                ...
                <a href="/auth/logout" class="list-group-item list-group-item-action">
            ...
            <?php elseif($this->session->user->level == "guru"): ?>
