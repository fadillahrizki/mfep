...
<div class="py-3 d-flex justify-content-between">
  <h3>Data Guru</h3>
  <a href="/guru/create" class="btn btn-success">
...
<?php if(isset($this->session->successCreate)): ?>
  <div class="alert alert-success">Berhasil Menambah Data Guru</div>
<?php unset($_SESSION['successCreate']);endif; ?>

<?php if(isset($this->session->successUpdate)): ?>
  <div class="alert alert-success">Berhasil Mengedit Data Guru</div>
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <?php $no=1; foreach($data as $guru): ?>
      <tr>
        <th><?=$no?></th>
        <td><?=$guru->pengguna->nama?></td>
        <td><?=$guru->pengguna->jenis_kelamin?></td>
        <td><?=$guru->kelas->nama?></td>
        <td>
          <a href="/guru/edit?id=<?=$guru->id?>" class="btn btn-warning btn-sm">
          ...
          <a href="/guru/delete?id=<?=$guru->id?>" class="btn btn-danger btn-sm">
